...
const Instructions = () => {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-semibold mb-6">Instructions for GRE Mock Test</h1>
      ...
      <div className="mt-8">
        <Link href="/mock-tests/65efaaa9089eca86da736740">
          <Button variant="primary" className="bg-strong text-white hover:bg-strong/80">Start Test</Button>
        </Link>
      </div>
    </div>
  );
